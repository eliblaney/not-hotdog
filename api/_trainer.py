# I adapted this helpful script from @kmather73 on GitHub
...
def loadData(img_size, classSize):
    hotdogs = glob.glob('./images/train/hotdog/*.jpg', recursive=True)
    notHotdogs = glob.glob('./images/train/not_hot_dog/*.jpg', recursive=True)
